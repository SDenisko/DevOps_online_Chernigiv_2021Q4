...
--
-- Host: devopsonlinelocal.cpriyhidtmjl.us-east-2.rds.amazonaws.com    Database: DevOpsLocal
-- ------------------------------------------------------
...
--
-- Table structure for table `testRDS`
--

DROP TABLE IF EXISTS `testRDS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `testRDS` (
  `id` int NOT NULL,
  `second_column` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `testRDS`
--

LOCK TABLES `testRDS` WRITE;
/*!40000 ALTER TABLE `testRDS` DISABLE KEYS */;
/*!40000 ALTER TABLE `testRDS` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-28  9:17:09
